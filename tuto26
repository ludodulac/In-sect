...
const SLIDES = [
  ...
  /* 9 — SUPER POUVOIRS */
  {
    ...
    desc: `Option activable avant la partie — désactivée par défaut :`,
    stakes: [
      { ico:'⚙️', txt:`<b>Optionnel</b> — Les super pouvoirs sont <b>désactivés par défaut</b>. Vous pouvez les activer dans les options de configuration avant de lancer une partie.` },
