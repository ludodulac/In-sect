...
function sendFeedback() {
  ...
  const body    = encodeURIComponent(parts || 'Bonjour Ludovic, voici mon avis sur IN-SECT…');
  window.location.href = `mailto:ludovicdulac@yahoo.com?subject=${subject}&body=${body}`;
  hideModal('feedback');
}
function resumeGame() {
