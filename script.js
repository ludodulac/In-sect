...
const PDESC = {
  chef:       "Dame aux échecs. <b>Tue</b> en se posant sur l'ennemi — vous choisissez où poser la dépouille 💀. Seule pièce à entrer sur le <b>Nid Sacré 👑</b>. Sa mort = effondrement de toute la colonie.",
...
function humanClickCell(r,c){
  ...
  if (r===LAB.r&&c===LAB.c&&!clicked&&!G.sel){
    ...
    if (showcaseDesc) { showcaseDesc.innerHTML = "<b>La Reine qui l\'occupe :</b> joue 2 actions/tour (duel) ou rejoue après chaque adversaire (guerre totale). <b>Immunisée contre les Fourmis Soldates.</b> Les autres pièces peuvent la traverser sans s\'y arrêter. La Reine peut quitter le Nid librement."; }
    if (showcase) showcase.classList.add('active');
    return;
  }
