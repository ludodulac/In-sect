...
const SLIDES = [
  ...
  /* 9 — PACTE DE NON-AGRESSION */
  {
    ...
    stakes: [
      { ico:'🤝', txt:`<b>Proposition automatique</b> — Au début de la partie, le jeu peut proposer un pacte entre deux colonies. Vous choisissez d'accepter ou de refuser.` },
      ...
      { ico:'🗡️', txt:`<b>Trahison possible</b> — Le pacte peut être rompu à tout moment. Rompre en premier est parfois la clé de la victoire… mais attention aux représailles !` },
      { ico:'👁️', txt:`<b>Visible dans l'interface</b> — La barre du bas indique en permanence si un pacte est actif et entre quelles colonies.` },
      { ico:'⚠️', txt:`<b>Uniquement en mode 4 colonies</b> — Le pacte n'existe pas en mode Duel 1 contre 1.` },
    ],
  },
