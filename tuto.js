...
const SLIDES = [
  ...
  /* 9 — SUPER POUVOIRS */
  {
    ...
    stakes: [
      { ico:'✨', txt:`<b>Cases aura</b> — Des cases violettes pulsantes apparaissent sur le plateau. La première pièce à s'y poser reçoit un super pouvoir unique.` },
      ...
      { ico:'🐜', txt:`<b>Portée Reine (Fourmi)</b> — La Fourmi se déplace désormais comme une Reine aux échecs : portée illimitée dans toutes les directions.` },
      { ico:'🐞', txt:`<b>Alliés déplaçables (Coccinelle)</b> — La Coccinelle peut désormais déplacer ses propres pièces alliées, en plus des pièces ennemies.` },
      { ico:'🪲', txt:`<b>Résurrection (Scarabée)</b> — Le Scarabée peut choisir n'importe quelle dépouille sur le plateau et la ressusciter pour qu'elle rejoigne sa colonie.` },
