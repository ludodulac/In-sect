...
const SLIDES = [
  ...
  /* 9 — SUPER POUVOIRS */
  {
    ...
    stakes: [
      ...
      { ico:'🐞', txt:`<b>Alliés déplaçables (Coccinelle)</b> — La Coccinelle peut déplacer ses propres pièces alliées, en plus des pièces ennemies.` },
      { ico:'🪲', txt:`<b>Résurrection (Scarabée)</b> — Le Scarabée choisit n'importe quelle dépouille et la ressuscite pour sa colonie.` },
